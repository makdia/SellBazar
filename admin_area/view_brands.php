...
<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li><a href="#" style="background:#810541;">View All Types</a></li>
	...
	<h2 id="heading">List of all types</h2>
...
<div id="view_cat_list">
	...
	<div id="cat_list_title"><?php echo $brand_title;?></div>
	<a class="thumbnail" href="edit_brand.php?edit_brand=<?php echo $brand_id;?>" style="text-align:center;margin-top:107px;float:left;color:#ffffff;background:#008000;font-weight:bolder;text-decoration:none;width:70px;height:50px;padding:10px;font-family:italic;font-size:18px;">Edit</a>
	<a class="thumbnail" href="delete_brand.php?delete_brand=<?php echo $brand_id;?>" style="text-align:center;margin-top:153px;width:70px;height:50px;float:left;color:#ffffff;background:#FFA500;font-weight:bolder;text-decoration:none;padding:10px;font-family:italic;font-size:18px;">Delete</a>
</div>
