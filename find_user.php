	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="#">Find User</a></li>
			</ul>
				...
				<div class="product_area">
					...
					<div id="search_box">
						...
						if(isset($_SESSION['customer_email'])) {
							...
							//here i add ($user) and (where condition) for not showing current login user
							$get_pro = "select * from customers where customer_email!='$user' order by RAND()";
							...
							global $con;
							//here i add ($user) and (where condition) for not showing current login user
							$get_pro = "select * from customers order by RAND()";
							$run_pro = mysqli_query($con, $get_pro);
							while($row_pro=mysqli_fetch_array($run_pro)) {
								$c_id=$row_pro['customer_id'];	
								$c_name=$row_pro['customer_name'];
